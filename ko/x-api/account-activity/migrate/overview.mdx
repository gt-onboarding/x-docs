...
| ----- | ----- | ----- |
| POST /1.1/account\_activity/webhooks.json?url=\<URL> | POST /2/webhooks | [Docs](https://docs.x.com/ko/x-api/webhooks/introduction). OAuth2AppOnly 필요. |
| GET /1.1/account\_activity/webhooks.json | GET /2/webhooks | [Docs](https://docs.x.com/ko/x-api/webhooks/introduction). OAuth2AppOnly 필요. |
| PUT /1.1/account\_activity/webhooks/:webhook\_id.json | PUT /2/webhooks/:webhook\_id | CRC 트리거. [Docs](https://docs.x.com/ko/x-api/webhooks/introduction). OAuth2AppOnly 필요. |
| DELETE /1.1/account\_activity/webhooks/:webhook\_id.json | DELETE /2/webhooks/:webhook\_id | [Docs](https://docs.x.com/ko/x-api/webhooks/introduction). OAuth2AppOnly 필요. |
...
마이그레이션 시 새 기본 경로로 코드를 업데이트하고, 인증 플로우를 조정하며, [V2 Webhooks API](https://docs.x.com/ko/x-api/webhooks/introduction)를 사용해 webhook을 관리하세요.
...
- **인증을 OAuth 2.0으로 업데이트**:
  ...
  - Developer Portal에서 다음을 관리하세요:
    ...
    - 클라이언트 ID와 클라이언트 시크릿
- **웹훅 확인 또는 재구성**:
  - 기존 웹훅 URL을 사용하거나 새 웹훅을 설정하세요(예: https://your\_domain.com/webhook/twitter).
  - 웹훅을 등록하고 관리하려면 [V2 Webhooks API 문서](https://docs.x.com/ko/x-api/webhooks/introduction)를 따르세요.
- **샘플 앱:**
