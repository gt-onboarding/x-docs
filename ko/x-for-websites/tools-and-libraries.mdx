...
아래 도구로 웹사이트에서 X를 쉽게 시작할 수 있습니다.
...
>
트윗 임베드와 X 카드 등을 통해 WordPress 사이트를 X에 최적화하는 공식 플러그인입니다.
</Card>
<Card
  title="twemoji"
  icon="x-twitter"
...
>
크로스 플랫폼 지원을 위한 JavaScript 라이브러리를 포함한 X의 무료 오픈 소스 이모지 글리프 세트입니다.
</Card>
</CardGroup>
...
다음 도구는 폭넓은 웹 개발자 커뮤니티에서 제공·지원하며, 공식 리소스가 아닙니다. 이러한 기여를 해주신 커뮤니티에 감사드립니다.
...
제작: [@MichaelDeBoey](https://github.com/MichaelDeBoey)
</Card>
</CardGroup>
...
<CardGroup cols={3}>
 ...
 [@jsternberg](https://github.com/jtsternberg) 제공
  </Card>
</CardGroup>