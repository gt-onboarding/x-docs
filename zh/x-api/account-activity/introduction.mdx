...
通过 Account Activity API 返回的帖子将计入每月的[推文上限（帖子上限）](https://docs.x.com/x-api/fundamentals/post-cap)。
...
<div id="removing-subscriptions">
  ### [移除订阅](https://docs.x.com/x-api/account-activity/deactivates-a-subscription-for-the-specified-webhook-and-user-id)
</div>
...
有！请参阅 [Webhooks 入门指南](https://docs.x.com/x-api/webhooks/introduction)以及 [Account Activity API 示例应用](https://github.com/m-rosinsky/XWebhookTest/blob/main/app.py)。
...
有关 webhook 管理端点（注册、查看、验证、删除），请参见 [V2 Webhooks API 文档](https://docs.x.com/x-api/webhooks/introduction)