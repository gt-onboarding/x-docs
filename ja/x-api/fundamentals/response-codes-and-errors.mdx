...
| 401 | Unauthorized | リクエストの認証に問題がありました。認証情報の欠如や誤りが原因の可能性があります。その他の未定義の状況でも返される場合があります。 | 正しい[認証方法](https://docs.x.com/ja/resources/fundamentals/authentication/overview)を使用し、認証情報が正しいことを確認してください。 |
