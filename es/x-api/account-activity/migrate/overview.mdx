...
Al migrar, actualice su código para usar las nuevas rutas base, ajuste los flujos de autenticación y gestione los webhooks mediante la [API de Webhooks v2](https://docs.x.com/x-api/webhooks/introduction).
...
* **Verifique o reconfigure su webhook**:  
  ...
  * Siga la [documentación de la Webhooks API v2](https://docs.x.com/x-api/webhooks/introduction) para registrar y administrar su webhook.  
