...
I post restituiti dall’Account Activity API concorrono al conteggio mensile dei [limiti di post](https://docs.x.com/x-api/fundamentals/post-cap).
...
<div id="adding-a-subscription">
  ### [Aggiunta di un abbonamento](https://docs.x.com/x-api/account-activity/subscribes-the-provided-application-to-all-events-for-the-provided-user-context-for-all-message-types)
</div>
...
<div id="checking-a-subscription">
  ### [Verifica di una sottoscrizione](https://docs.x.com/x-api/account-activity/check-if-a-subscription-exists-for-a-given-webhook-and-user)
</div>
...
<div id="removing-subscriptions">
  ### [Rimozione delle iscrizioni](https://docs.x.com/x-api/account-activity/deactivates-a-subscription-for-the-specified-webhook-and-user-id)
</div>
...
<div id="viewing-all-subscriptions">
  ### [Visualizzazione di tutte le sottoscrizioni](https://docs.x.com/x-api/account-activity/get-a-list-of-the-current-all-activity-type-subscriptions-for-the-specified-webhook)
</div>
...
<div id="subscriptions-count">
  ### [Conteggio abbonamenti](https://docs.x.com/x-api/account-activity/get-a-count-of-subscriptions-that-are-currently-active-on-your-account)
</div>
...
Consulta la nostra [guida alla migrazione](https://docs.x.com/x-api/account-activity/migrate/overview)!
...
Sì! Puoi registrare più URL di webhook e gestire separatamente le sottoscrizioni tramite la [V2 Webhooks API](https://docs.x.com/x-api/webhooks/introduction).

**Avete guide passo passo su come configurare la Account Activity API?**

Sì! Consulta la [Guida introduttiva ai Webhook](https://docs.x.com/x-api/webhooks/introduction) e la [Sample Application della Account Activity API](https://github.com/m-rosinsky/XWebhookTest/blob/main/app.py).
...
Per gli endpoint di gestione dei webhook (registrazione, visualizzazione, convalida, eliminazione), consulta la [documentazione dell’API Webhooks V2](https://docs.x.com/x-api/webhooks/introduction)