...
Os Posts retornados pela Account Activity API contam para os [limites de posts](https://docs.x.com/x-api/fundamentals/post-cap) mensais.
...
<div id="adding-a-subscription">
  ### [Adicionando uma assinatura](https://docs.x.com/x-api/account-activity/subscribes-the-provided-application-to-all-events-for-the-provided-user-context-for-all-message-types)
</div>
...
<div id="checking-a-subscription">
  ### [Verificando uma assinatura](https://docs.x.com/x-api/account-activity/check-if-a-subscription-exists-for-a-given-webhook-and-user)
</div>
...
<div id="removing-subscriptions">
  ### [Removendo assinaturas](https://docs.x.com/x-api/account-activity/deactivates-a-subscription-for-the-specified-webhook-and-user-id)
</div>
...
<div id="viewing-all-subscriptions">
  ### [Visualizar todas as assinaturas](https://docs.x.com/x-api/account-activity/get-a-list-of-the-current-all-activity-type-subscriptions-for-the-specified-webhook)
</div>
...
<div id="subscriptions-count">
  ### [Contagem de assinaturas](https://docs.x.com/x-api/account-activity/get-a-count-of-subscriptions-that-are-currently-active-on-your-account)
</div>
...
Veja nosso [Guia de migração](https://docs.x.com/x-api/account-activity/migrate/overview)!
...
Sim! Você pode registrar várias URLs de webhook e gerenciar assinaturas separadamente por meio da [V2 Webhooks API](https://docs.x.com/x-api/webhooks/introduction).

**Vocês têm algum guia passo a passo sobre como começar a usar a Account Activity API?**

Sim! Consulte o [guia de Introdução aos Webhooks](https://docs.x.com/x-api/webhooks/introduction) e o [aplicativo de exemplo da Account Activity API](https://github.com/m-rosinsky/XWebhookTest/blob/main/app.py).
...
Para endpoints de gerenciamento de webhooks (registrar, visualizar, validar, excluir), consulte a [documentação da Webhooks API v2](https://docs.x.com/x-api/webhooks/introduction)