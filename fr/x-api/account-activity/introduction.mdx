...
Les posts renvoyés par l’API Account Activity sont comptabilisés dans le [plafond de posts](https://docs.x.com/fr/x-api/fundamentals/post-cap) mensuel.
...
<div id="adding-a-subscription">
  ### [Ajouter un abonnement](https://docs.x.com/fr/x-api/account-activity/subscribes-the-provided-application-to-all-events-for-the-provided-user-context-for-all-message-types)
</div>
...
<div id="checking-a-subscription">
  ### [Vérifier un abonnement](https://docs.x.com/fr/x-api/account-activity/check-if-a-subscription-exists-for-a-given-webhook-and-user)
</div>
...
<div id="removing-subscriptions">
  ### [Suppression des abonnements](https://docs.x.com/fr/x-api/account-activity/deactivates-a-subscription-for-the-specified-webhook-and-user-id)
</div>
...
<div id="viewing-all-subscriptions">
  ### [Afficher toutes les abonnements](https://docs.x.com/fr/x-api/account-activity/get-a-list-of-the-current-all-activity-type-subscriptions-for-the-specified-webhook)
</div>
...
<div id="subscriptions-count">
  ### [Nombre d’abonnements](https://docs.x.com/fr/x-api/account-activity/get-a-count-of-subscriptions-that-are-currently-active-on-your-account)
</div>
...
<div id="replay">
  ## [Relecture](https://docs.x.com/fr/x-api/account-activity/request-activity-replay)
</div>
...
Consultez notre [Guide de migration](https://docs.x.com/fr/x-api/account-activity/migrate/overview) !
...
Oui ! Vous pouvez enregistrer plusieurs URL de webhook et gérer les abonnements séparément via la [V2 Webhooks API](https://docs.x.com/fr/x-api/webhooks/introduction).

**Avez-vous des guides pas à pas pour configurer l’API Account Activity ?**

Oui ! Consultez le [guide de démarrage avec les webhooks](https://docs.x.com/fr/x-api/webhooks/introduction) et l’[application d’exemple Account Activity API](https://github.com/m-rosinsky/XWebhookTest/blob/main/app.py).
...
Pour les points de terminaison de gestion des webhooks (enregistrer, afficher, valider, supprimer), voir la [documentation de l’API Webhooks V2](https://docs.x.com/fr/x-api/webhooks/introduction)